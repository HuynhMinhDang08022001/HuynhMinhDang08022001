    ...
    while k < row_count2:
        ...
        if str(row_list_DID_latestSW) != "None":
            ...
            if str(row_list_values_latestSW) == 'None':
                hexvalue_latestSW = str(".{" + str(row_list_length_byte_latestSW) + "}")
                # print('dung')
            else:
                # change ascii sang hex value
